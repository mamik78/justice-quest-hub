...
import { BarChart3, Book, Award, Map } from "lucide-react";
import { Card } from "@/components/ui/card";
import BadgeDisplay from "@/components/quiz/BadgeDisplay";
import ServiceJuridictionFinder from "@/components/juridiction/ServiceJuridictionFinder";
...
const ProfilePage = () => {
  ...
  const handleSubmitFeedback = () => {
    if (feedback.trim()) {
      // Dans une vraie application, on enverrait un email à tprx-mantes-la-jolie@justice.fr
      console.log("Feedback soumis:", feedback);
      toast.success("Merci pour votre retour ! Un email a été envoyé à tprx-mantes-la-jolie@justice.fr");
        ...
        <TabsContent value="services">
          <div className="bg-white rounded-xl shadow-md overflow-hidden mb-8 animate-fade-in">
            <div className="bg-gradient-to-r from-justice-primary to-justice-dark p-6 text-white">
              ...
              <p className="text-justice-light">Trouvez les établissements près de chez vous</p>
            </div>
            
            <div className="p-6">
              <ServiceJuridictionFinder />
            </div>
          </div>
        </TabsContent>
      </Tabs>
